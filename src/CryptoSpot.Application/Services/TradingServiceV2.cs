...
{
    /// <summary>
    /// DTO交易服务实现 - 修复了K-line数据映射调用
    /// </summary>
    public class TradingServiceV2 : ITradingServiceV2
    {
        private readonly IDtoMappingService _mappingService;
        private readonly ILogger<TradingServiceV2> _logger;
        ...
        public TradingServiceV2(
            IDtoMappingService mappingService,
            ILogger<TradingServiceV2> logger,
